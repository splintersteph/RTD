...
const PDP_CATEGORY_LABELS = { standard: 'Tenons standards', '3d': 'Tenons 3D', drill: 'Forets (Drills)' };
...
function renderPdpPage() {
  ...
  if (!pdpSelectedClient) {
    ...
    function renderRefsGrid(list, groupsMap) {
      ...
      return ['standard', '3d', 'drill'].filter(k => cats[k].length).map(k =>
