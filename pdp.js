  ...
  if (!pdpSelectedClient) {
    ...
    clients.forEach(cl => {
      ...
      refs.forEach(r => {
        ...
        totalCdes    += pdpGetCommandesForRef(pdpResolveFG(r.codart_wip));
      });
    ...
    sortedRefs.forEach(r => {
      ...
      const cde = pdpGetCommandesForRef(pdpResolveFG(r.codart_wip));
...
function pdpResolveFG(codart_wip) {
  if (typeof nomenclatures === 'undefined') return codart_wip;
