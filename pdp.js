...
function pdpRenderCard(r, col) {
  ...
  return '<div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:12px 14px;display:flex;flex-direction:column;gap:8px">'
    ...
    + '<button onclick="pdpRenameRef(\'' + r.code_client + '\')" title="Renommer" style="background:none;border:none;cursor:pointer;color:var(--text-faint);font-size:12px;padding:2px"><i class="ti ti-pencil"></i></button>'
    + '</div>'
    ...
    + '<button onclick="pdpMoveRef(\'' + r.code_client + '\',-1)" style="background:none;border:none;cursor:pointer;color:var(--text-faint);font-size:11px;padding:2px 5px" title="Monter"><i class="ti ti-arrow-up"></i></button>'
    + '<button onclick="pdpMoveRef(\'' + r.code_client + '\',1)" style="background:none;border:none;cursor:pointer;color:var(--text-faint);font-size:11px;padding:2px 5px" title="Descendre"><i class="ti ti-arrow-down"></i></button>'
    + '</div>'
    + '</div>';
}
